...
Confirm the home page loads, each catalog category is reachable, a representative resource opens for every provider, and the catalog count is 36 active resources. Check deployment logs for startup or database errors.
