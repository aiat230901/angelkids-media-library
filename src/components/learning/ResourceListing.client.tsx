...
export function ResourceListing({ resources, detailBasePath }: { resources: PublicResource[]; detailBasePath?: string }) {
  ...
  return (
    <>
      <ResourceFilters value={filters} levels={options.levels} curriculumUnits={options.curriculumUnits} onChange={setFilters} onReset={() => setFilters(EMPTY_FILTERS)} />
